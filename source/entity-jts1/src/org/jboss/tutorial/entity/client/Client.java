...
public class Client {
	...
	public Client() {
		...
		try {
				...
				//props.put(Context.PROVIDER_URL,"jnp://localhost:1102,jnp://127.0.0.1:1100,jnp://127.0.0.1:1200");
				props.put(Context.PROVIDER_URL,"jnp://localhost:1102");
			...
			if (ctx != null) {
				try {
					...
					System.out.println("Client finally catch");
					e.printStackTrace();
				}
			}
		}
